            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <form method="POST" action="{{ route('post.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="title" :value="old('title')" 
                    ...
                    <div class="mt-4">
                        ...
                        <x-input-textarea id="content" name="content" class="block mt-1 w-full">
                            {{ old('content') }}
                        </x-input-textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="published_at" :value="old('published_at')" 
